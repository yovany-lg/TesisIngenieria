...
\begin{itemize} \itemsep=-0.5em
	...
	\item\emph{Oxígeno Disuelto (OD)}: Para el tratamiento secundario este parámetro es fundamental, ya que determina la cantidad de oxígeno ($O_2$) disponible por los microorganismos presentes en el tratamiento secundario. Se recomienda que el valor del OD este por arriba de $3$ a $4\frac{\milli\gram {O}_{2}}{\liter}$ \cite{Cap2Bib:Metcalf}.
